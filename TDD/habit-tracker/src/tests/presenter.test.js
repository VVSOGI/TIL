...
describe('All Test of HabitPresenter', () => {
  ...
  test('List length is 3 when Doing anything', () => {
    expect(Presenter.getHabits().length).toBe(3);
  });

  test('List length is 4 when add element', () => {
    Presenter.add('add', update);
    expect(Presenter.getHabits().length).toBe(4);
  });

  test('List length is 2 when remove element', () => {
    Presenter.delete({ id: 1 }, update);
    expect(Presenter.getHabits().length).toBe(2);
  });

  test('Target count + 1 when doing Presenter method increment', () => {
    const target = { id: 1, name: 'Reading', count: 0 };
  ...
  test('Doing decrement when count is 0 equal 0', () => {
    const target = { id: 1, name: 'Reading', count: 0 };
  ...
  test('Doing decrement when count is N equal N - 1', () => {
  ...
  test('Doing reset is all list count make 0', () => {
    const mockListData = [
  ...
  test('Doing reset when all list count is 0', () => {
